...
namespace WebAppManagementV2.Controllers
{
    public class CreateBankDbController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            empManager.CreateAsync(man1, "P4$$word");
            ...
            empManager.CreateAsync(man2, "P4$$word");
            #endregion
            ...
            bc.Employees.AddRange(employees);
            #endregion
            ...
            //{
            //    if (!bc.Roles.Any(r => r.Name == role))
            //    {
            //        bc.Roles.Add(new IdentityRole(role));
            //    }
            //}
            //#endregion
